...
import com.google.gerrit.server.query.QueryBuilder.Operator;
...
@Singleton
public class SampleOperator implements DynamicBuilder {
  ...
  @Operator
  public Predicate<ChangeData> sample(String value) throws QueryParseException {
